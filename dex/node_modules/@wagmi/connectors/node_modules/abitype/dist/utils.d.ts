import { Abi, AbiParameter, AbiStateMutability, AbiType, MBits, SolidityAddress, SolidityArray, SolidityBool, SolidityBytes, SolidityFixedArrayRange, SolidityFixedArraySizeLookup, SolidityFunction, SolidityInt, SolidityString, SolidityTuple, TypedData, TypedDataParameter, TypedDataType } from './abi';
 ...
 */
export declare type AbiTypeToPrimitiveType<TAbiType extends AbiType> = PrimitiveTypeLookup<TAbiType>[TAbiType];
 ...
 * @returns TypeScript primitive type
 */
export declare type AbiParameterToPrimitiveType<TAbiParameter extends AbiParameter | {
    name: string;
    type: unknown;
 ...
 */
export declare type ExtractAbiFunctions<TAbi extends Abi, TAbiStateMutibility extends AbiStateMutability = AbiStateMutability> = Extract<TAbi[number], {
    type: 'function';
 ...
 */
export declare type ExtractAbiFunctionNames<TAbi extends Abi, TAbiStateMutibility extends AbiStateMutability = AbiStateMutability> = ExtractAbiFunctions<TAbi, TAbiStateMutibility>['name'];
/**
 ...
 */
export declare type ExtractAbiFunction<TAbi extends Abi, TFunctionName extends ExtractAbiFunctionNames<TAbi>> = Extract<ExtractAbiFunctions<TAbi>, {
    name: TFunctionName;
}>;
/**
 ...
 */
export declare type ExtractAbiErrors<TAbi extends Abi> = Extract<TAbi[number], {
    type: 'error';
}>;
/**
 ...
 */
export declare type ExtractAbiErrorNames<TAbi extends Abi> = ExtractAbiErrors<TAbi>['name'];
/**
 ...
 */
export declare type ExtractAbiError<TAbi extends Abi, TErrorName extends ExtractAbiErrorNames<TAbi>> = Extract<ExtractAbiErrors<TAbi>, {
    name: TErrorName;
}>;
/**
 ...
 */
export declare type IsTypedData<TTypedData> = TTypedData extends TypedData ? {
