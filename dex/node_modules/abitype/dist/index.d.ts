 ...
 */
declare type Narrow<TType> = (TType extends Function ? TType : never) | (TType extends string | number | boolean | bigint ? TType : never) | (TType extends [] ? [] : never) | {
 ...
 */
declare type AbiTypeToPrimitiveType<TAbiType extends AbiType> = PrimitiveTypeLookup<TAbiType>[TAbiType];
declare type PrimitiveTypeLookup<TAbiType extends AbiType> = {
...
declare type GreaterThan48Bits = Exclude<MBits, 8 | 16 | 24 | 32 | 40 | 48 | ''>;
declare type LessThanOrEqualTo48Bits = Exclude<MBits, GreaterThan48Bits | ''>;
declare type DynamicBits = Exclude<MBits, GreaterThan48Bits | LessThanOrEqualTo48Bits>;
declare type BitsTypeLookup = {
 ...
 * @returns TypeScript primitive type
 */
declare type AbiParameterToPrimitiveType<TAbiParameter extends AbiParameter | {
    name: string;
    type: unknown;
 ...
 */
declare type AbiParametersToPrimitiveTypes<TAbiParameters extends readonly AbiParameter[]> = {
 ...
 */
declare type IsAbi<TAbi> = TAbi extends Abi ? true : false;
/**
 ...
 */
declare type ExtractAbiFunctions<TAbi extends Abi, TAbiStateMutibility extends AbiStateMutability = AbiStateMutability> = Extract<TAbi[number], {
    type: 'function';
 ...
 */
declare type ExtractAbiFunctionNames<TAbi extends Abi, TAbiStateMutibility extends AbiStateMutability = AbiStateMutability> = ExtractAbiFunctions<TAbi, TAbiStateMutibility>['name'];
/**
 ...
 */
declare type ExtractAbiFunction<TAbi extends Abi, TFunctionName extends ExtractAbiFunctionNames<TAbi>> = Extract<ExtractAbiFunctions<TAbi>, {
    name: TFunctionName;
}>;
/**
 ...
 */
declare type ExtractAbiEvents<TAbi extends Abi> = Extract<TAbi[number], {
    type: 'event';
}>;
/**
 ...
 */
declare type ExtractAbiEventNames<TAbi extends Abi> = ExtractAbiEvents<TAbi>['name'];
/**
 ...
 */
declare type ExtractAbiEvent<TAbi extends Abi, TEventName extends ExtractAbiEventNames<TAbi>> = Extract<ExtractAbiEvents<TAbi>, {
    name: TEventName;
}>;
/**
 ...
 */
declare type ExtractAbiErrors<TAbi extends Abi> = Extract<TAbi[number], {
    type: 'error';
}>;
/**
 ...
 */
declare type ExtractAbiErrorNames<TAbi extends Abi> = ExtractAbiErrors<TAbi>['name'];
/**
 ...
 */
declare type ExtractAbiError<TAbi extends Abi, TErrorName extends ExtractAbiErrorNames<TAbi>> = Extract<ExtractAbiErrors<TAbi>, {
    name: TErrorName;
}>;
/**
 ...
 */
declare type IsTypedData<TTypedData> = TTypedData extends TypedData ? {
 ...
 */
declare type TypedDataToPrimitiveTypes<TTypedData extends TypedData> = {
    [K in keyof TTypedData]: {
...
declare type _TypedDataParametersToAbiParameters<TTypedDataParameters extends readonly TypedDataParameter[], TTypedData extends TypedData> = {
