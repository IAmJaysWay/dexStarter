 ...
 */
declare type Merge<Object1, Object2> = Omit<Object1, keyof Object2> & Object2;
/**
 ...
 * [string, string]
 */
declare type Tuple<Type, Size extends number> = Size extends Size ? number extends Size ? Type[] : _TupleOf<Type, Size, []> : never;
