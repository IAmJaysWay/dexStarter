...
function InnerRangePicker(props) {
  ...
  var presetList = (0, _usePresets.default)(presets, ranges); // ============================= Panel =============================
  ...
  function renderPanel() {
    ...
    return /*#__PURE__*/React.createElement(_RangeContext.default.Provider, {
      ...
      onSelect: undefined,
      onChange: undefined,
      defaultValue: mergedActivePickerIndex === 0 ? (0, _miscUtil.getValue)(selectedValue, 1) : (0, _miscUtil.getValue)(selectedValue, 0) // defaultPickerValue={undefined}
