...
import { RpcProvidersMap, RpcProviderMap, RequestParams, RequestArguments, SessionNamespace, NamespaceConfig, ConnectParams } from "./misc";
...
export interface IUniversalProvider extends IEthereumProvider {
    ...
    sendAsync: (args: RequestArguments, callback: (error: Error | null, response: any) => void, chain?: string) => void;
