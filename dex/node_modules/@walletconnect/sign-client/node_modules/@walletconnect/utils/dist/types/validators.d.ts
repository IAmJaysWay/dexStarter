...
export declare function isValidExtension(namespace: any, method: string): ErrorObject;
...
export declare function isValidNamespaceChains(namespaces: any, method: string): null;
...
export declare function isValidRequiredNamespaces(input: any, method: string): ErrorObject;
